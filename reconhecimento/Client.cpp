#define VERBOSE false     // turn on or off debugging output
...
Client::Client(const char* pStrHost, int iPort, bool* pResult, int iPortDatagram, bool bReverse)
{
...
int Client::RecvString(char* pStr, int iMax, char chTerm)
{
	...
	// RETORNA DIRETAMENTE A STRING RECEBIDA ATRAVÉS DO PARAMETRO "*pStr"
